...
const SidebarTab = (
  ...
  return (
    <button
      ref={forwardedRef}
      className={`flex justify-center flex-1 py-1.5 px-6 rounded-t hover:bg-gray-100 active:bg-gray-200 dark:hover:bg-gray-700 dark:active:bg-gray-600 border-y-2  dark:border-gray-700 ${
