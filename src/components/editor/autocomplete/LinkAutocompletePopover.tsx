...
// when type `[[w`, note-link
// start to search note, build select options, replace markdown
// workfolow: 
//  1- type `[[` and any word, call LinkAutocomplete here
//  2- if select seached option, generate note-link
//  3- if not, when type ]] to enclose the text input, 
//     call handelInlineShortcuts, 
//     find existing note or create new one then generate note-link
