...
test("renders sub marks", () => {
  expect(renderToHtml(`this is &subscript& text`)).toMatchSnapshot();
});

test("renders sup marks", () => {
  expect(renderToHtml(`this is ^superscript^ text`)).toMatchSnapshot();
});

test("renders hashtag marks", () => {
  expect(renderToHtml(`this is #hashtag# text`)).toMatchSnapshot();
});
...
test("renders strikethrough marks", () => {
